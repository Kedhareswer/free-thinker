...
class Agent:
    ...
    def execute(self, prompt):
        ...
        Returns:
        dict: A structured result containing information about the execution suitable for UI consumption.
        """
        ...
        for tool in self.tools:
            if tool.__name__ == tool_choice:
                ...
                # Structured return for UI consumption
                return {
                    "mode": "tool",
        ...
        # Answer by model
        print(colored(f'\n{tool_input[0]}', 'green'))
        print(colored(f'Model used: {self.model_name}\n', 'yellow'))

        return {
            "mode": "model",
            "tool_name": "no_tool",
            "tool_input": tool_input,
            "output": tool_input[0] if tool_input else "",
            "model_used": self.model_name,
        }
